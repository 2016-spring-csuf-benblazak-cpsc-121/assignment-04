/* ----------------------------------------------------------------------------
* Copyright &copy; 2016 Philip Dang <philipdang@csu.fullerton.edu>
* Released under the [MIT License] (http://opensource.org/licenses/MIT)
* ------------------------------------------------------------------------- */

/**
* A short program to display selection sort and merge sort fuctions.
*/
...
int main() {
	std::vector<int> a = { 22, 1, 63, 67, 11, 17, 12, };
	print_vector(a);
	std::cout << std::endl;
	selection_sort(a);
	...
	std::cout << std::endl;
	std::vector<int> b = { 22, 1, 63, 67, 11, 17, 12, };
	print_vector(b);
	std::cout << std::endl;
	merge_sort(b);
